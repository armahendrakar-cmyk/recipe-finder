...
**Live Demo Link:** https://recipefinder-mern.netlify.app/
...
1.  **Clone the repository:**
    ```sh
    git clone https://github.com/armahendrakar-cmyk/recipe-finder.git
    cd recipe-finder
    ```
...
Anusha R Mahendrakar - [armahendrakar@gmail.com](mailto:armahendrakar@gmail.com)

Project Link: [https://github.com/armahendrakar-cmyk/recipe-finder](https://github.com/armahendrakar-cmyk/recipe-finder)
